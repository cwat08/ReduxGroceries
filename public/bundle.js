...
var ADD_GROCERY = 'ADD_GROCERY';

//Action Creator

var nextId = 0;

var addGrocery = exports.addGrocery = function addGrocery(string) {
  return {
    type: ADD_GROCERY,
    id: nextId++,
    string: string
...
var reducer = function reducer() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { groceries: [] };
  var action = arguments[1];

  switch (action.type) {
    case ADD_GROCERY:
      {
        var newItem = { id: action.id, string: action.string, bought: false };
        var newState = _extends({}, state, { groceries: [].concat(_toConsumableArray(state.groceries), [newItem]) });
...
var _AddGrocery = __webpack_require__(38);

var _AddGrocery2 = _interopRequireDefault(_AddGrocery);

var _GroceryList = __webpack_require__(65);
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement("input", {
          ...
          onChange: function onChange(evt) {
            return _this2.setState({ input: evt.target.value });
          },
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return { add: function add(string) {
      return dispatch((0, _store.addGrocery)(string));
    } };
};

exports.default = (0, _reactRedux.connect)(null, mapDispatchToProps)(AddGrocery);
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(8), __webpack_require__(40)(module)))
...
var _GroceryItem = __webpack_require__(66);
...
exports.default = (0, _reactRedux.connect)(mapStateToProps)(GroceryList);
